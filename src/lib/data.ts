...
export const ORDERS: Order[] = [
  { id: "ORD-1042", customerId: "c1", customerName: "Hayley Holst", storeSlug: "supermarket", items: [{ productId: "sm-1", name: "Fresh Milk 2L", qty: 2, price: 28.99 }, { productId: "sm-3", name: "Golden Delicious Apples", qty: 1, price: 24.99 }], total: 82.97, status: "delivered", type: "delivery", createdAt: "2026-06-18T10:30:00", deliveryAddress: "12 Main Rd, Greytown", fleetId: "f1" },
  ...
  { id: "ORD-1046", customerId: "c3", customerName: "Ananth Mahabeer", storeSlug: "supermarket", items: [{ productId: "sm-5", name: "Tastic Rice 2kg", qty: 1, price: 39.99 }, { productId: "sm-7", name: "Coca-Cola 2L", qty: 3, price: 22.99 }], total: 108.96, status: "processing", type: "delivery", createdAt: "2026-06-21T13:00:00", deliveryAddress: "78 Voortrekker St, Greytown", fleetId: "f3" },
